<<<<<<< HEAD
'''
3D Eigenvalue One Implementation
Testing on Hydrogen Atom with Analytic Ground State
@author: nathanvaughn
'''    
# import tools
import sys
...
#     V = potential(x, y, z)
    ...
    while deltaE > tolerance:
        ...
        E_old = E
        psi,alpha = inverise_iteration(V, E, psi, x, y, z)
        psi = normalize_wavefunction(psi, dx, dy, dz, W)
        E = NewtonUpdate(V, psi, x, y, z, W)
        print('E = ',E)
        deltaE = abs(E-E_old)
...
if ( (__name__ == "__main__") or (__name__ == "EigenvalueOne") ):
