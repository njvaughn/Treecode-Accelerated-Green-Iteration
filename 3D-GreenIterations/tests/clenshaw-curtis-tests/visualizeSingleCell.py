...
zvec = ChebyshevPoints(zmin,zmax,order)
xw = weights(xmin,xmax,order)
yw = weights(ymin,ymax,order)
...
savefile="/Users/nathanvaughn/Desktop/meshTests/forVisitTesting/singleCell"
